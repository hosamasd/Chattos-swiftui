    ...
    var body: some View{
        ...
        ZStack(alignment: Alignment(horizontal: .trailing, vertical: .top), content: {
            ...
            VStack{
                ...
                .padding(.vertical,22)
                .disabled(!model.checkEmailAndPasswordAndRepeat() ? true : false)
                .opacity(!model.checkEmailAndPasswordAndRepeat() ? 0.5 : 1)
...
struct LoginVssisew_Previews: PreviewProvider {
